...
export function ExperienceSection() {
  return (
    <SectionWrapper id="experience" title="Work Experience" icon={sectionIcons.experience}>
      <div className="relative flex flex-col gap-8 before:absolute before:left-[1.1rem] before:top-4 before:h-full before:w-[2px] before:bg-border md:before:left-5">
        {workExperience.map((job, index) => (
          <Card key={index} className="pl-12 md:pl-16 relative">
            <div className="absolute left-0 top-5 flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 border-2 border-primary md:h-10 md:w-10">
