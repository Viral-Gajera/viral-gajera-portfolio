...
const allCategories: ProjectCategory[] = Array.from(new Set(projects.map(p => p.category))) as ProjectCategory[];
      ...
      <AnimatePresence>
        ...
        >
          {paginatedProjects.length > 0 ? (
                ...
                <Link href={`/projects/${project.slug}`}>
                  ...
                  <CardContent className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {project.techStack.length > 4 && <Badge variant="outline">...</Badge>}
                    </div>
                  </CardContent>
                </Link>
            ...
            <p className="text-muted-foreground md:col-span-2 lg:col-span-3 text-center">No projects found.</p>
          )}
        </motion.div>
      </AnimatePresence>
